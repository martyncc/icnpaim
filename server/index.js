...
app.listen(PORT, () => {
  ...
  console.log(`🚀 Launch URL: https://icnpaim.cl/lti/launch`);
  console.log(`🔑 JWKS URL: https://icnpaim.cl/.well-known/jwks.json`);
  console.log(`📱 Dashboard: https://icnpaim.cl/student-dashboard`);
});